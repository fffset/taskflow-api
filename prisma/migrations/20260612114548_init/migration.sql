...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_COMMENT', 'TASK_STATUS_CHANGED', 'TASK_DUE_SOON', 'WORKSPACE_INVITE', 'MENTION');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'INVITE_SENT', 'INVITE_ACCEPTED', 'ROLE_CHANGED');
...
-- CreateIndex
CREATE INDEX "project_statuses_workspaceId_idx" ON "project_statuses"("workspaceId");

-- CreateIndex
CREATE UNIQUE INDEX "project_statuses_workspaceId_name_key" ON "project_statuses"("workspaceId", "name");
...
-- AddForeignKey
ALTER TABLE "project_statuses" ADD CONSTRAINT "project_statuses_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
